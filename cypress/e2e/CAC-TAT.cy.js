    // Seção 1: Instalação e baixando o arquivo
  ...
  // Exercício: 12 - Lidando com links 
    ...
    // SEÇÃO 12: Gestão de Testes na nuvem com o serviço Cypress Cloud 

    // SEÇÃO 13: Avançando usando Cypress
    ...
    // E com a funcionalidade cy.tick(), você pode avançar no tempo. 
     ...
     // Exércicio 13: cy.clock() // cy.tick()
    
      it('Exibir a mensagem por 3 segundos', () => {
        cy.clock()
    ...
    // Exercicio 13.1 -> Feito em outra aba

    //Exercício: 14 -> Comando .invoke()
    // Mostrando conteúdo oculto no HTML
...
//Exercício: 14 -> Comando .invoke() Colando conteúdo direto no 
// Mostrando conteúdo oculto no HTML

it('preenche o campo da área de texto usando o comando invoke.', ()=>{
  cy.get('#open-text-area')
    .invoke('val', 'Adicionando um texto com invoke')
    .should('have.value', 'Adicionando um texto com invoke')

})

// Exercício 15: Comando cy.request()
// Usando cy.request na requisição
